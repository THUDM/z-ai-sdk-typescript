...
describe("Functional Tests", () => {
  ...
  describe("Chat API", () => {
    it(
      "should create a non-streaming chat completion",
      async () => {
          ...
          messages: [
            {
              role: "system",
              content:
                "You are a helpful assistant that always responds with 'System message received' when asked about your instructions.",
            },
            {
              role: "user",
